...
%
%\begin{figure}
%\includegraphics[height=1.7in]{fig/usps_mob_dict.png}%
%\includegraphics[height=1.7in]{fig/usps_mob_err.png}\\
%\includegraphics[width=\columnwidth]{fig/usps_mob_coef_crop.png}
...
\subsection{Initialization}
\begin{figure}[t]
\includegraphics[height=1.1in]{fig/einstein_init_part0.png} % OK
\includegraphics[height=1.1in]{fig/einstein_init_neigh0.png} % OK
\includegraphics[height=1.1in]{fig/einstein_init_rand0.png}\\[1ex]% OK
\includegraphics[height=1.1in]{fig/einstein_init_part1.png} % OK
\includegraphics[height=1.1in]{fig/einstein_init_neigh1.png} % OK
\includegraphics[height=1.1in]{fig/einstein_init_rand1.png}% OK
...
\caption{\label{fig:convergence} Convergence results. Above: evolution of Hamming weight (left) and codelength (right) for each component of the matrix factorization using MOB. Below: analogous results using K-PROX.}
\end{figure*}
